...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Button_button_js__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__SocialLinks_socialLinks_js__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SocialShare_socialShare_js__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Accordian_accordian_js__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Tabs_tabs_js__ = __webpack_require__(22);
/**
 * Aione Blocks
 *
...
registerBlockType('aione-blocks/aione-button', {
    ...
    edit: function edit(props) {
        ...
        var setSize = function setSize(selectedSize) {
            props.setAttributes({ buttonSize: selectedSize });
        };
        var setStyle = function setStyle(selectedStyle) {
            props.setAttributes({ buttonStyle: selectedStyle });
        };
        var setButtonBGColor = function setButtonBGColor(selectedBGColor) {
            props.setAttributes({ buttonBGColor: selectedBGColor });
        };
        var setButtonTextColor = function setButtonTextColor(selectedTextColor) {
            props.setAttributes({ buttonTextColor: selectedTextColor });
        };
        var setButtonBorderColor = function setButtonBorderColor(selectedBorderColor) {
            props.setAttributes({ buttonBorderColor: selectedBorderColor });
        };
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(SelectControl, {
                        ...
                        value: buttonSize,
                        onChange: setSize,
                        options: [{ value: 'small', label: 'Small' }, { value: 'medium', label: 'Medium' }, { value: 'large', label: 'Large' }, { value: 'fullwidth', label: 'Fullwidth' }]
                    }),
                    wp.element.createElement(SelectControl, {
                    ...
                    buttonOutline && wp.element.createElement(TextControl, {
    ...
    save: function save(props) {
        var _props$attributes2 = props.attributes,
            ...
            buttonStyle = _props$attributes2.buttonStyle,
...
registerBlockType('aione-blocks/aione-social-icons', {
    ...
    edit: function edit(props) {
        ...
        var _props$attributes = props.attributes,
            ...
            socialIconStyle = _props$attributes.socialIconStyle,
            socialIconDirection = _props$attributes.socialIconDirection,
            socialIconTheme = _props$attributes.socialIconTheme,
            socialIconLabels = _props$attributes.socialIconLabels,
        ...
        var onChangeFacebookUrl = function onChangeFacebookUrl(FacebookUrl) {
            props.setAttributes({ facebookUrl: FacebookUrl });
        };

        var onChangeYoutubeUrl = function onChangeYoutubeUrl(YoutubeUrl) {
            props.setAttributes({ youtubeUrl: YoutubeUrl });
        };

        var onChangeTwitterUrl = function onChangeTwitterUrl(TwitterUrl) {
            props.setAttributes({ twitterUrl: TwitterUrl });
        };

        var onChangeLinkedinUrl = function onChangeLinkedinUrl(LinkedinUrl) {
            props.setAttributes({ linkedinUrl: LinkedinUrl });
        };

        var onChangeInstagramUrl = function onChangeInstagramUrl(InstagramUrl) {
            props.setAttributes({ instagramUrl: InstagramUrl });
        };

        var onChangeGithubUrl = function onChangeGithubUrl(GithubUrl) {
            props.setAttributes({ githubUrl: GithubUrl });
        };

        var onChangeRSSUrl = function onChangeRSSUrl(RSSUrl) {
            props.setAttributes({ rssUrl: RSSUrl });
        };

        var onChangeTumblrUrl = function onChangeTumblrUrl(TumblrUrl) {
            props.setAttributes({ tumblrUrl: TumblrUrl });
        };

        var onChangePinterestUrl = function onChangePinterestUrl(PinterestUrl) {
        ...
        var onChangeSocialIconStyle = function onChangeSocialIconStyle(selectedStyle) {
            props.setAttributes({ socialIconStyle: selectedStyle });
        };
        var onChangeSocialIconDirection = function onChangeSocialIconDirection(selectedDirection) {
            props.setAttributes({ socialIconDirection: selectedDirection });
        };
        var onChangeSocialIconTheme = function onChangeSocialIconTheme(selectedTheme) {
        ...
        return [isSelected && wp.element.createElement(
            ...
            wp.element.createElement(
                PanelBody,
                { title: __('Enable/Disable Links'), initialOpen: false },
                wp.element.createElement(
                    'div',
                    { className: 'blocks-font-size__main' },
                    wp.element.createElement(ToggleControl, {
                        ...
                        onChange: function onChange() {
                            return props.setAttributes({ facebook: !facebook });
                        }
                    }),
                    props.attributes.facebook && wp.element.createElement(TextControl, {
                        label: 'Facebook Link',
                        value: facebookUrl,
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!youtube,
                        onChange: function onChange() {
                            return props.setAttributes({ youtube: !youtube });
                        }
                    }),
                    props.attributes.youtube && wp.element.createElement(TextControl, {
                        label: 'Youtube Link',
                        value: youtubeUrl,
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!twitter,
                        onChange: function onChange() {
                            return props.setAttributes({ twitter: !twitter });
                        }
                    }),
                    props.attributes.twitter && wp.element.createElement(TextControl, {
                        label: 'Twitter Link',
                        value: twitterUrl,
                    ...
                    props.attributes.linkedin && wp.element.createElement(TextControl, {
                        label: 'Linkedin Link',
                        value: linkedinUrl,
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!instagram,
                        onChange: function onChange() {
                            return props.setAttributes({ instagram: !instagram });
                        }
                    }),
                    props.attributes.instagram && wp.element.createElement(TextControl, {
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!github,
                        onChange: function onChange() {
                            return props.setAttributes({ github: !github });
                        }
                    }),
                    props.attributes.github && wp.element.createElement(TextControl, {
                        label: 'GitHub Link',
                        value: githubUrl,
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!pinterest,
                        onChange: function onChange() {
                            return props.setAttributes({ pinterest: !pinterest });
                        }
                    }),
                    props.attributes.pinterest && wp.element.createElement(TextControl, {
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!tumblr,
                        onChange: function onChange() {
                            return props.setAttributes({ tumblr: !tumblr });
                        }
                    }),
                    props.attributes.tumblr && wp.element.createElement(TextControl, {
                        label: 'Tumblr Link',
                        value: tumblrUrl,
                        onChange: onChangeTumblrUrl
                    }),
                    wp.element.createElement(ToggleControl, {
                        label: __('RSS'),
                        checked: !!rss,
                        onChange: function onChange() {
                            return props.setAttributes({ rss: !rss });
                        }
                    }),
                    props.attributes.rss && wp.element.createElement(TextControl, {
                        label: 'RSS Link',
                        value: rssUrl,
            ...
            wp.element.createElement(
                PanelBody,
                { title: __('Icon Options'), initialOpen: false },
                wp.element.createElement(
                    'div',
                    { className: 'blocks-font-size__main' },
                    wp.element.createElement(SelectControl, {
                        ...
                        options: [{ value: 'small', label: 'Small' }, { value: 'medium', label: 'Medium' }, { value: 'large', label: 'Large' }, { value: 'xlarge', label: 'XLarge' }]
                    }),
                    wp.element.createElement(SelectControl, {
                        label: __('Select Style:'),
                    ...
                    wp.element.createElement(SelectControl, {
                        ...
                        options: [{ value: 'colored', label: 'Colored' }, { value: 'dark', label: 'Dark' }, { value: 'dark-solid', label: 'Dark Solid' }, { value: 'dark-outline', label: 'Dark Outline' }, { value: 'light bg-black', label: 'Light' }, { value: 'light-solid bg-black', label: 'Light Solid' }, { value: 'light-outline bg-black', label: 'Light Outline' }]
                    }),
                    wp.element.createElement(ToggleControl, {
                        label: __('Enable Labels'),
                        checked: !!socialIconLabels,
                        onChange: function onChange() {
                            return props.setAttributes({ socialIconLabels: !socialIconLabels });
                        }
                    })
                )
            )
            ...
            wp.element.createElement(
                'div',
                { className: 'aione-social-icons-container' },
                wp.element.createElement(
                    'ul',
                    { className: 'aione-social-icons' + ' ' + socialIconSize + ' ' + socialIconStyle + ' ' + socialIconDirection + ' ' + socialIconTheme + ' ' + classes },
                    props.attributes.facebook && wp.element.createElement(
                        'li',
                        { 'class': 'facebook' },
                        wp.element.createElement(
                            'a',
                    ...
                    props.attributes.youtube && wp.element.createElement(
                        'li',
                        { 'class': 'youtube' },
                        wp.element.createElement(
                            'a',
                    ...
                    props.attributes.twitter && wp.element.createElement(
                        'li',
                        { 'class': 'twitter' },
                        wp.element.createElement(
                            'a',
                    ...
                    props.attributes.linkedin && wp.element.createElement(
                        'li',
                        { 'class': 'linkedin' },
                        wp.element.createElement(
                            'a',
                    ...
                    props.attributes.instagram && wp.element.createElement(
                        'li',
                        { 'class': 'instagram' },
                        wp.element.createElement(
                            'a',
                    ...
                    props.attributes.tumblr && wp.element.createElement(
                        'li',
                        { 'class': 'tumblr' },
                        wp.element.createElement(
                            'a',
                    ...
                    props.attributes.rss && wp.element.createElement(
                        'li',
                        { 'class': 'rss' },
                        wp.element.createElement(
                            'a',
    ...
    save: function save(props) {
        var _props$attributes2 = props.attributes,
            socialIconSize = _props$attributes2.socialIconSize,
            socialIconStyle = _props$attributes2.socialIconStyle,
            socialIconDirection = _props$attributes2.socialIconDirection,
            socialIconTheme = _props$attributes2.socialIconTheme,
            socialIconLabels = _props$attributes2.socialIconLabels,
            facebook = _props$attributes2.facebook,
            youtube = _props$attributes2.youtube,
            twitter = _props$attributes2.twitter,
            linkedin = _props$attributes2.linkedin,
        ...
        return [isSelected && wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(ToggleControl, {
                        ...
                        checked: !!reddit,
                        onChange: function onChange() {
                            return props.setAttributes({ reddit: !reddit });
                        }
                    }),
                    wp.element.createElement(ToggleControl, {
                        label: __('Tumblr'),
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    props.attributes.reddit && wp.element.createElement(
                        'li',
                        { 'class': 'reddit' },
                        wp.element.createElement(
                            'a',
...
registerBlockType('aione-blocks/aione-accordian', {
    ...
    edit: function edit(props) {
        ...
        return [isSelected && wp.element.createElement(
            InspectorControls,
            null,
            wp.element.createElement(PanelBody, { title: __('Settings'), initialOpen: false })
        ), wp.element.createElement(
            'div',
            { className: props.className },
            wp.element.createElement(
                'div',
                { className: 'aione-block-accordion' },
                props.children,
                wp.element.createElement(RichText, {
                    tagName: 'p',
                    ...
                    keepPlaceholderOnFocus: true,
                    className: 'aione-accordion-title',
                    onChange: function onChange(value) {
                        return props.setAttributes({ accordionTitle: value });
                    }
                }),
                wp.element.createElement(RichText, {
                    tagName: 'p',
                    ...
                    className: 'aione-accordion-text',
                    onChange: function onChange(value) {
                        return props.setAttributes({ accordionText: value });
                    }
                })
            )
        )];
    ...
    save: function save(props) {
        var _props$attributes2 = props.attributes,
            ...
            accordionText = _props$attributes2.accordionText;
        ...
        return wp.element.createElement(
            ...
            wp.element.createElement(
                'div',
                { className: 'aione-block-accordion aione-collapsible' },
                props.children,
                wp.element.createElement(
                    'div',
                    { 'class': 'aione-item' },
                    // Check if there is an accordion title
                    accordionTitle && wp.element.createElement(
                        'div',
                        { 'class': 'aione-accordion-title aione-item-header' },
                        accordionTitle
                    ),
                    // Check if there is accordion text
                    accordionText && wp.element.createElement(
                        'div',
                        { 'class': 'aione-accordion-text aione-item-content' },
                        accordionText
                    )
                )
            )
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_sortable_hoc__ = __webpack_require__(23);
...
registerBlockType('aione-blocks/aione-tabs', {
    ...
    edit: function edit(props) {
        ...
        try {
            for (var _iterator = window.aioneTabbedContentBlocks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var bl = _step.value;
        ...
        var onChangeTabContent = function onChangeTabContent(content, i) {
            attributes.tabsContent[i].content = content;
            updateTimeStamp();
        };

        var onChangeTabTitle = function onChangeTabTitle(content, i) {
        ...
        var removeTab = function removeTab(i) {
            var tabsTitleClone = attributes.tabsTitle.slice(0);
            tabsTitleClone.splice(i, 1);
            setAttributes({ tabsTitle: tabsTitleClone });
            var tabsContentClone = attributes.tabsContent.slice(0);
        ...
        var onSortEnd = function onSortEnd(_ref) {
            ...
            setAttributes({ tabsTitle: Object(__WEBPACK_IMPORTED_MODULE_0_react_sortable_hoc__["arrayMove"])(titleItems, oldIndex, newIndex) });
            var contentItems = attributes.tabsContent.slice(0);
            setAttributes({ tabsContent: Object(__WEBPACK_IMPORTED_MODULE_0_react_sortable_hoc__["arrayMove"])(contentItems, oldIndex, newIndex) });
            ...
            block.SortableItem = Object(__WEBPACK_IMPORTED_MODULE_0_react_sortable_hoc__["SortableElement"])(function (_ref2) {
                ...
                return wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        wp.element.createElement('span', { className: 'dashicons dashicons-minus remove-tab-icon' + (propz.attributes.tabsTitle.length === 1 ? ' aione-hide' : ''), onClick: function onClick() {
            ...
            block.SortableList = Object(__WEBPACK_IMPORTED_MODULE_0_react_sortable_hoc__["SortableContainer"])(function (_ref3) {
                ...
                return wp.element.createElement(
                    ...
                    items.map(function (value, index) {
                        return wp.element.createElement(block.SortableItem, { propz: propz, key: 'item-' + index, i: index, index: index, value: value, onChangeTitle: onChangeTitle, onRemoveTitle: onRemoveTitle, toggleTitle: toggleTitle });
                    }),
                    wp.element.createElement(
                        'div',
                        { className: className + '-tab-title-wrap', key: propz.attributes.tabsTitle.length, onClick: function onClick() {
        ...
        return [isSelected && wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(SelectControl, {
                        ...
                        options: [{ value: 'theme-clean', label: 'Theme Clean' }, { value: 'theme-bold', label: 'Theme Bold' }, { value: 'theme-pastel', label: 'Theme Pastel' }, { value: 'theme-pointer', label: 'Theme Pointer' }, { value: 'theme-arrow', label: 'Theme Arrow' }]
                    }),
                    wp.element.createElement(ToggleControl, {
            ...
            'div',
            { className: className, key: 'tabber' },
            wp.element.createElement(
                'div',
                { className: className + '-holder' + ' aione-tabs ' + direction + ' ' + alignment + ' ' + layout + ' ' + theme + ' ' + marginClass + ' ' + hoverClass },
                wp.element.createElement(block.SortableList, { axis: 'x', propz: props, items: attributes.tabsTitle, onSortEnd: onSortEnd, useDragHandle: true, onChangeTitle: onChangeTabTitle, onRemoveTitle: removeTab, toggleTitle: showControls, onAddTab: addTab }),
                wp.element.createElement(
                    'div',
                    { className: className + '-tabs-content content' },
                    attributes.tabsContent.map(function (tabContent, i) {
                        return wp.element.createElement(
                            'div',
                            { id: 'tab_' + i, className: className + '-tab-content-wrap' + (attributes.activeTab === i ? ' active' : ' '), key: i },
                            wp.element.createElement(RichText, {
                                tagName: 'div',
                                ...
                                onClick: function onClick() {
                                    return showControls('tab-content', i);
                                },
                                onChange: function onChange(content) {
                                    return onChangeTabContent(content, i);
                                },
    ...
    save: function save(props) {
        ...
        var _props$attributes2 = props.attributes,
            activeTab = _props$attributes2.activeTab,
        ...
        return wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    props.attributes.tabsTitle.map(function (value, i) {
                        return wp.element.createElement(
                            'div',
                            {
                ...
                wp.element.createElement(
                    'div',
                    { className: className + '-tabs-content' + ' content' },
                    props.attributes.tabsContent.map(function (value, i) {
                        return wp.element.createElement(
                            'div',
                            { id: 'tab_' + i, className: className + '-tab-content-wrap' + (activeTab === i ? ' active' : ''), key: i },
                            wp.element.createElement(
                                'div',
                                { className: className + '-tab-content' },
                                value.content
...
var _SortableContainer2 = __webpack_require__(24);

var _SortableContainer3 = _interopRequireDefault(_SortableContainer2);

var _SortableElement2 = __webpack_require__(38);

var _SortableElement3 = _interopRequireDefault(_SortableElement2);

var _SortableHandle2 = __webpack_require__(39);
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(1),m=__webpack_require__(13),p=__webpack_require__(2),v=__webpack_require__(3),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ha=__webpack_require__(7);
